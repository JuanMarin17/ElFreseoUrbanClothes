...
const CMS_SECTIONS = [
  { key: "about",     label: "Quiénes Somos", icon: "ti-building-store", desc: "Historia, misión y visión de tu marca",          color: "#8b3cf7" },
  { key: "contact",   label: "Contacto",      icon: "ti-mail",           desc: "Teléfono, correo y formulario de contacto",       color: "#f5c842" },
  { key: "locations", label: "Ubicaciones",   icon: "ti-map-pin",        desc: "Tiendas físicas y puntos de venta",               color: "#00d4aa" },
  { key: "returns",   label: "Devoluciones",  icon: "ti-arrow-back-up",  desc: "Política de cambios y devoluciones",              color: "#ff6b6b" },
...
export default function CMSEditor() {
  ...
  // En admin mode cargamos qué secciones ya tienen datos
      ...
      <div className="cms-hub" style={{ padding: "0 0 40px" }}>
        <div className="cms-hub__header">
          ...
          <p className="cms-hub__sub">
            Personaliza las páginas informativas de tu tienda.
          </p>
        </div>
        {grid}
      </div>
  ...
  // ── Wizard mode: página completa standalone ───────────────────────────────
  return (
      ...
      <main className="cms-hub">
        ...
        <div className="cms-hub__footer">
          <p className="cms-hint">
            💡 Puedes saltar secciones y completarlas después desde el panel de administración.
          </p>
