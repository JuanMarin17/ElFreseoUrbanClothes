  ...
  return (
    <div className="admin-frame">
      ...
      <div className="cms-page cms-page--locations">
        <div className="cms-page__header">
          ...
          <div className="cms-page__titles">
            ...
            <p className="cms-page__sub">
              Agrega tus tiendas físicas y puntos de venta
            </p>
          </div>
        </div>
          ...
          <div className="toggle-field">
            <div className="toggle-field__info">
              ...
              <span className="toggle-field__desc">
                Muestra un mapa de Google Maps en la página de ubicaciones
              </span>
            </div>
        ...
        <div className="cms-form-card">
          <p className="cms-section-title">
            Puntos de Venta ({locations.length})
          </p>
            ...
            {locations.map((loc, idx) => (
              <div key={loc.id} className="cms-list-item">
                ...
                <div className="field-row-2">
                  <div className="field-group">
                    ...
                    <input
                      ...
                      value={loc.name}
                      onChange={(e) =>
                        updateLoc(loc.id, "name", e.target.value)
                      }
                    />
                  </div>
                  <div className="field-group">
                    ...
                    <input
                      ...
                      value={loc.city}
                      onChange={(e) =>
                        updateLoc(loc.id, "city", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="field-group">
                  ...
                  <input
                    className="f-input-dark"
                    placeholder="Calle 50 #10-45, El Poblado"
                    value={loc.address}
                    onChange={(e) =>
                      updateLoc(loc.id, "address", e.target.value)
                    }
                  />
                </div>
                ...
                <div className="field-row-2">
                  <div className="field-group">
                    ...
                    <input
                      ...
                      value={loc.phone}
                      onChange={(e) =>
                        updateLoc(loc.id, "phone", e.target.value)
                      }
                    />
                  </div>
                  <div className="field-group">
                    ...
                    <input
                      ...
                      value={loc.hours}
                      onChange={(e) =>
                        updateLoc(loc.id, "hours", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                {showMap && (
                  <div className="field-group">
                    ...
                    <input
                      ...
                      value={loc.mapUrl}
                      onChange={(e) =>
                        updateLoc(loc.id, "mapUrl", e.target.value)
                      }
                    />
                  </div>
                )}
                ...
                <div className="toggle-field" style={{ paddingTop: 8 }}>
                  ...
                  <label className="toggle-wrap">
                    <input
                      ...
                      onChange={(e) =>
                        updateLoc(loc.id, "isPrimary", e.target.checked)
                      }
                    />
                    <span className="toggle-track" />
                    <span className="toggle-thumb" />
          ...
          <button className="btn-add-item" onClick={addLoc}>
            + AGREGAR UBICACIÓN
          </button>
        </div>
