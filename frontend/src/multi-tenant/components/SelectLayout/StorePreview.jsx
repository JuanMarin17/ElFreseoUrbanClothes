    ...
    <div style={{ background: pageBg, color: isMin ? "#111" : isUrb ? "#fff" : "#1a1a1a", fontFamily: `"${fB}",sans-serif` }}>
      ...
      <header style={{
        ...
        <button style={{
          ...
          padding: "7px 16px", borderRadius: btnR, fontSize: 11,
          fontWeight: 700, letterSpacing: isUrb ? 2 : 0.5,
          cursor: "pointer", opacity: isMin ? 0.8 : 1,
        }}>
          {isUrb ? "BAG" : "🛒 Carrito"}
        </button>
      </header>
      ...
      {isMin && (
        <section style={{
          ...
          <span style={{
            ...
            fontSize: 11, letterSpacing: 5, fontWeight: 700,
          ...
          <h1 style={{
            ...
            lineHeight: 1, margin: 0, maxWidth: 700,
          }}>
            {banner.title}
          </h1>
      ...
      {isUrb && (
        <section style={{
          ...
          {banner._imageUrl && (
            <img src={banner._imageUrl} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center", zIndex: 0 }} />
          )}
          {banner._imageUrl && (
            <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 1 }} />
          )}
          <div style={{ position: "absolute", top: 0, left: "clamp(16px,3vw,40px)", width: 1, height: "100%", background: "#1a1a1a", zIndex: 2 }} />
          <span style={{ position: "relative", zIndex: 2, fontSize: 10, letterSpacing: 5, color: accent, textTransform: "uppercase", marginBottom: 12, fontWeight: 700 }}>— DROP 2026</span>
          <h1 style={{ position: "relative", zIndex: 2, fontFamily: `"${cf(banner.font)}",sans-serif`, fontSize: "clamp(2.5rem,8vw,6.5rem)", color: banner.color ?? "#fff", lineHeight: 0.9, margin: "0 0 20px", textTransform: "uppercase", letterSpacing: -2, wordBreak: "break-word" }}>{banner.title}</h1>
          <div style={{ position: "relative", zIndex: 2, display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
            ...
            <span style={{ fontSize: 12, color: "#666", letterSpacing: 2 }}>{desc}</span>
          </div>
        </section>
      )}
      ...
      {isCls && (
        <section style={{
          ...
          minHeight: 200,
          overflow: "hidden",
          background: banner._imageUrl ? "#000" : `linear-gradient(135deg, ${banner.bg ?? "#1a1a2e"}, ${accent}cc)`,
          ...
          <div style={{ position: "relative", zIndex: 2, flex: 1, minWidth: 180 }}>
          ...
          <button style={{ position: "relative", zIndex: 2, background: "#fff", border: "none", color: accent, padding: "11px 24px", borderRadius: btnR, fontSize: 13, fontWeight: 800, cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0 }}>COMPRAR AHORA →</button>
        </section>
      )}
