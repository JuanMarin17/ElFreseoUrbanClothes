...
const DEMO = {
  ...
  styles: {
    ...
    colorParrafo: "#888888",
    cardBg: "#0f0f0f",
    cardBorderColor1: "#3e78ff",
    cardBorderColor2: "#6c63ff",
    cardBorderWidth: "2",
    cardRadius: "12",
    ...
    fontTitle: "Inter",
    fontBody: "Inter",
    textoTitulo: "PRODUCTO",
    textoCuerpo: "Descripción del producto.",
  },
  widgets: null,
};
...
export default function StorePreview({
  ...
  const accent =
    styles.colorBoton ?? (isMin ? "#111" : isUrb ? "#fff" : "#3e78ff");
  const titleC =
    styles.colorTitulo ?? (isMin ? "#111" : isUrb ? "#fff" : "#1a1a1a");
  const paraC =
    styles.colorParrafo ?? (isMin ? "#888" : isUrb ? "#555" : "#666");
  const cardBg = styles.cardBg ?? (isMin ? "#fff" : isUrb ? "#0a0a0a" : "#fff");
  const b1 =
    styles.cardBorderColor1 ?? (isMin ? "#e5e5e5" : isUrb ? "#222" : "#ddd");
  const b2 =
    styles.cardBorderColor2 ?? (isMin ? "#e5e5e5" : isUrb ? "#333" : "#ddd");
  ...
  const btnR = `${styles.btnRadius ?? 4}px`;
  ...
  const srBorder =
    srch?.borderColor ?? (isMin ? "#e0e0e0" : isUrb ? "#222" : "#e0e0e0");
    ...
    searchVisible ? (
      <div
        style={{
          ...
          minWidth: 100,
          background: srBg,
          border: `${srBorderW}px solid ${srBorder}`,
          borderRadius: srRadius,
          padding: "7px 12px",
          display: "flex",
          alignItems: "center",
          gap: 7,
          fontFamily: `"${srFont}",sans-serif`,
        }}
      >
        {srIcon && <SearchIcon />}
        <span
  ...
  const Sidebar = () =>
    sidebarVisible ? (
      <aside
        style={{
          background: sbBg,
          border: `${sbBorderW}px solid ${sbBorder}`,
          borderRadius: sbRadius,
          padding: "16px 0",
          marginRight: 16,
          fontFamily: `"${sbFont}",sans-serif`,
          minWidth: 0,
          flexShrink: 0,
        }}
      >
        ...
        {sbItems.map((item, i) => (
          <div
            ...
            style={{
              padding: "8px 12px",
              fontSize: 12,
              color: i === 0 ? accent : sbColor,
              fontWeight: i === 0 ? 700 : 400,
              borderLeft:
                i === 0 ? `3px solid ${accent}` : "3px solid transparent",
  ...
  return (
    <div
      style={{
        background: pageBg,
        color: isMin ? "#111" : isUrb ? "#fff" : "#1a1a1a",
    ...
    >
      ...
      {/* ══════════════════════════════════════
          HEADER — limpio, sin nada adentro
      ══════════════════════════════════════ */}
      <header
        style={{
          background: hBg,
      ...
      >
        {/* Nav izquierda solo en minimalista */}
        {isMin && (
          <nav style={{ display: "flex", gap: "clamp(10px,2vw,24px)" }}>
        ...
        {/* Buscador en urbano y clásico */}
        {(isUrb || isCls) && <SearchBar maxWidth={isUrb ? 280 : 340} />}

        {/* Nav derecha en urbano y clásico */}
        {!isMin && (
          <nav style={{ display: "flex", gap: "clamp(10px,2vw,24px)" }}>
            {(header.items ?? []).map((it, i) => (
              <span
      ...
      {/* ══════════════════════════════════════
          BANNER MINIMALISTA
          imagen absoluta al fondo, texto encima
      ══════════════════════════════════════ */}
      {isMin && (
        <section
          style={{
            ...
            minHeight: 520,
            overflow: "hidden",
            background: banner._imageUrl ? "#000" : "#ffffff",
            display: "flex",
            flexDirection: "column",
            justifyContent: "center",
            padding: "clamp(48px,8vw,100px) clamp(48px,6vw,80px)",
            gap: 20,
          }}
        >
          {/* ✅ Imagen al fondo — z-index 0 */}
          {banner._imageUrl && (
            <img
              src={banner._imageUrl}
              alt=""
              style={{
                position: "absolute",
                inset: 0,
          ...
          <span
            style={{
              ...
              letterSpacing: 5,
              fontWeight: 700,
              color: banner._imageUrl ? "rgba(255,255,255,0.6)" : accent,
              textTransform: "uppercase",
            }}
          >
            Nueva colección
          ...
          <h1
            style={{
              ...
              color: banner._imageUrl ? "#ffffff" : "#111",
              lineHeight: 1,
              margin: 0,
              maxWidth: 700,
            }}
          ...
          <p
            style={{
              ...
              zIndex: 2,
              fontSize: 15,
              color: banner._imageUrl ? "rgba(255,255,255,0.65)" : "#888",
              lineHeight: 1.7,
              maxWidth: 440,
              margin: 0,
            }}
      ...
      {isUrb && (
        <section
          style={{
            position: "relative",
            minHeight: "clamp(260px,45vw,520px)",
            background: banner._imageUrl ? "#000" : (banner.bg ?? "#0a0a0a"),
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 12, color: "#666", letterSpacing: 2 }}>
              {desc}
            </span>
          </div>
        </section>
      ...
      {isCls && (
        ...
        >
          ...
          <div
            style={{ position: "relative", zIndex: 2, flex: 1, minWidth: 180 }}
          >
            <span
              style={{
                background: accent,
      ...
      >
        {isUrb ? (
          ...
          >
            ...
            {isMin && (
              <span style={{ fontSize: 11, color: accent, cursor: "pointer" }}>
                Ver todo →
              </span>
            )}
          </div>
        ...
        <div style={{ display: "flex", gap: 0, alignItems: "start" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div
              style={{
                display: "grid",
                gridTemplateColumns: `repeat(auto-fit,minmax(${isUrb ? "160px" : "140px"},1fr))`,
                gap: isUrb ? 2 : 12,
              }}
            >
              {products.map((p, i) => (
                ...
                >
                  <div style={{ position: "relative" }}>
                    <div
                      style={{
                        height: isUrb ? "clamp(100px,16vw,180px)" : 140,
                        background: `${accent}${isUrb ? "15" : "10"}`,
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                      }}
                  ...
                  <div
                    style={{
                      padding: isUrb ? "12px 14px 14px" : "10px 12px 12px",
                    }}
                  >
                    <h3
                      style={{
                        fontFamily: `"${fT}",sans-serif`,
                        fontSize: isUrb ? "clamp(12px,2vw,18px)" : 12,
                        color: titleC,
                        margin: "0 0 5px",
                        fontWeight: 700,
                        textTransform: isUrb ? "uppercase" : "none",
                    ...
                    >
                      <span
                        style={{
                          fontFamily: `"${fT}",sans-serif`,
                          fontSize: isUrb ? "clamp(12px,2vw,16px)" : 14,
                          fontWeight: 800,
                          color: accent,
                        }}
                      >
                      ...
                      <button
                        style={{
                          background: isMin ? "transparent" : accent,
                          border: isMin ? `1px solid ${accent}` : "none",
                          color: isMin ? accent : isUrb ? "#000" : "#fff",
                          padding: "5px 10px",
                          borderRadius: btnR,
                          fontSize: 10,
                          fontWeight: 700,
      ...
      >
        <span
          style={{
            ...
            fontSize: 12,
            color: footer.color ?? (isUrb ? "#333" : "#888"),
            letterSpacing: isUrb ? 2 : 0,
            textTransform: isUrb ? "uppercase" : "none",
          }}
        >
          {footer.text}
