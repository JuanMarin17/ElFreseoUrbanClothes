...
const PLAN_STATIC_BENEFITS = {
  ...
  PRO:      ["Tienda pública en Vexio", "Dominio personalizado", "Analíticas avanzadas", "Soporte prioritario"],
  PREMIUM:  ["Tienda pública en Vexio", "Dominio personalizado", "Punto de venta presencial", "Analíticas avanzadas", "Múltiples usuarios", "Soporte 24/7"],
};
