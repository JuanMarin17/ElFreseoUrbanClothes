...
const ProductDetail = ({ product, onClose }) => {
  ...
  return (
    <div className="detailOverlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
          ...
          <div className="detailContent">
            ...
            <header className="detailHeader">
              ...
              <div className="detailRating">
                <div className="stars">
                  {[1, 2, 3, 4].map(s => <Star key={s} size={18} fill="#3b82f6" stroke="#3b82f6" />)}
            ...
            <div className="detailMeta">
              <div className="metaItem"><Truck size={20} /> <span>Envío express gratis en pedidos +$150.000</span></div>
              <div className="metaItem"><RotateCcw size={20} /> <span>Garantía de devolución de 30 días</span></div>
            </div>
            ...
            <section className="detailSection">
              ...
              <div className="commentBox">
                ...
                <p className="commentText">El corte es perfecto y el color azul neón resalta muchísimo en persona. 10/10.</p>
              </div>
